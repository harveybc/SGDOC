...
<?php $this->setPageTitle('Búsqueda'); ?>
<div class="form">
    <b></b><br/>
...
// Si existe el parámetro $_GET[OT]
    echo CHtml::textField('query', isset($_GET['query']) ? $_GET['query'] : "", array());
    ?>
...
//crea el formulario
    ...
    if (isset($_GET['query'])) {
        ...
        // para cada resultado
        foreach ($modelos as $modelo) {
            array_push($rutas, array('titulo' => $modelo->titulo, 'ruta' => '/index.php/metaDocs/view/' . $modelo->id, 'ubicacion' => 'Ruta Metadatos', 'contenido' => $modelo->ruta, 'id' => $contador++));
        }
        ...
        // para cada resultado
        foreach ($modelos as $modelo) {
            array_push($rutas, array('titulo' => $modelo->titulo, 'ruta' => '/index.php/metaDocs/view/' . $modelo->id, 'ubicacion' => 'Autor Metadatos', 'contenido' => $modelo->autores, 'id' => $contador++));
        }
        ...
        // busca en e
        foreach ($modelos as $modelo) {
            array_push($rutas, array('titulo' => $modelo->descripcion, 'ruta' => '/index.php/anotaciones/view/' . $modelo->id, 'ubicacion' => 'Título Anotación', 'contenido' => $modelo->descripcion, 'id' => $contador++));
        }
