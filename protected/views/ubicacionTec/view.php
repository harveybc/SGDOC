...
<?php $this->setPageTitle('Detalles de Ubicación Técnica #'.$model->id.''); ?>
...
<br /><h2> Estos documentos son de este  UbicacionTec: </h2>
<ul><?php foreach($model->metaDocs as $foreignobj) { 
				...
				} ?></ul><br /><h2> This UbicacionTec belongs to this UbicacionTec: </h2>
<ul><?php foreach($model->ubicacionTecs as $foreignobj) { 
				...
				} ?></ul><br /><h2> This Usuarios belongs to this UbicacionTec: </h2>
