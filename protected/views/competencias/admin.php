...
$this->menu=array(
		array('label'=>Yii::t('app',
				'Lista de Competencias'), 'url'=>array('index')),
		array('label'=>Yii::t('app', 'Nueva Competencia'),
				'url'=>array('create')),
			);
		...
		Yii::app()->clientScript->registerScript('search', "
			...
			$('.search-form form').submit(function(){
				$.fn.yiiGridView.update('competencias-grid', {
data: $(this).serialize()
});
				return false;
				});
...
<?php $this->setPageTitle(' Gestionar&nbsp;Competencias'); ?>
