...
class MetaDocs extends CActiveRecord
{
	...
	{
		return array(
			array('cerveceria,titulo', 'required'),
//                        array('modulo, columna, fila,tipoContenido, fabricante, cerveceria, medio, idioma, disponibles, existencias, modulo, columna, fila, documento, usuario, revisado, userRevisado, eliminado, secuencia, ordenSecuencia,ubicacionT, ', 'numerical', 'integerOnly'=>true),
                        array('ISBN, EAN13', 'length', 'max'=>32),
			array('numPedido, numComision, version', 'length', 'max'=>64),
			array('descripcion, titulo, autores', 'length', 'max'=>256),
                        array('ubicacionT_str', 'length', 'max'=>512),
			array('id, tipoContenido, fabricante, cerveceria, numPedido, numComision, ubicacionT, descripcion, titulo, version, medio, idioma, disponibles, existencias, modulo, columna, fila, documento, ruta, fechaCreacion, fechaRecepcion, autores, usuario, revisado, userRevisado, fechaRevisado, fechaCreacion, eliminado, secuencia, ordenSecuencia, ISBN, EAN13', 'safe', 'on'=>'search'),
                        //array('image', 'file', 'types'=>'jpg, gif, png,pfd'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'ubicacionT' => Yii::t('app', 'Ubicación'),
			...
			'fila' => Yii::t('app', 'Fila'),
			'documento' => Yii::t('app', 'Unidad Documental'),
			...
			'EAN13' => Yii::t('app', 'EAN-13'),
                        'ubicacionT_str' => Yii::t('app', 'Ubicación Técnica'),
		);
	}
